    ...
    <html>
        ...
        <body>
            <cfoutput>
                ...
                <form name="frmJobApplication" action="./form2.cfm" id="frmJobApplication" method="get" class="content" enctype="multipart/form-data">
                    <div class="form">
                        <div class="form-head">
                        ...
                        <div class="employee">
                            ...
                            <input type="radio" id="selfEmployee" name="employee" value="self-employee" />
